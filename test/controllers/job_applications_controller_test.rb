...
class JobApplicationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create job_application" do
    assert_difference("JobApplication.count") do
      post job_applications_url, params: { job_application: { applied_at: @job_application.applied_at, company_name: @job_application.company_name, description: @job_application.description, location: @job_application.location, position: @job_application.position, status: @job_application.status, url: @job_application.url } }
    end
  ...
  test "should update job_application" do
    patch job_application_url(@job_application), params: { job_application: { applied_at: @job_application.applied_at, company_name: @job_application.company_name, description: @job_application.description, location: @job_application.location, position: @job_application.position, status: @job_application.status, url: @job_application.url } }
